...
<head>
  ...
  <title>My Ideas - InformateU</title>
  <style>
...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="nav-menu">
      <a href="Homeserv" class="nav-item">
      ...
      <a href="Displayinfo" class="nav-item active">
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
  ...
  <div class="main-content">
    <div class="header">
      ...
      <div class="user-profile">
        ...
        <form action="info.html" method="POST">
         ...
         <button onclick="deleteIdea()" class="btn-primary">
    			Delete Idea
  		</button>
  		<button onclick="editIdea()" class="btn-primary">
    			Edit Idea
  		</button>
    ...
    <div class="welcome-banner">
      <div class="banner-decoration">â</div>
      <h2>Your Shared Knowledge</h2>
      <p>Review and manage the ideas you've contributed to the InformateU community.</p>
    </div>
...
%>
    ...
    <span class="card-tag">
        #<%= row.get("info_id") %> | <%= row.get("domain") %>
    </span>
...
%>
  ...
  <script>
function editIdea() {
    let id = prompt("Enter Info ID to edit:");
    
    if (id == null || id.trim() === "") {
        return;
    }

    let newInfo = prompt("Enter new info:");
    ...
    fetch("Editserv", {
        ...
        body: "info_id=" + id + "&info=" + encodeURIComponent(newInfo)
    })
    .then(res => res.text())
    .then(data => {
        alert(data);
  ...
  <script>
function deleteIdea() {
    let id = prompt("Enter Info ID to delete:");

    if (id != null && id.trim() !== "") {
        window.location.href = "Deleteinfo?info_id=" + id;
    }
}
</script>
</body>
